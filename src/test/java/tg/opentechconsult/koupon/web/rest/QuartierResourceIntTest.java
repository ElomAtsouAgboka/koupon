...
import tg.opentechconsult.koupon.repository.QuartierRepository;
import tg.opentechconsult.koupon.repository.search.QuartierSearchRepository;
...
public class QuartierResourceIntTest {
     ...
     *
     * @see tg.opentechconsult.koupon.repository.search.QuartierSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    public void checkNomQuartierIsRequired() throws Exception {
