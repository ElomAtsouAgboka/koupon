...
import { MarchandComponent } from 'app/entities/marchand/marchand.component';
...
describe('Component Tests', () => {
    describe('Marchand Management Component', () => {
        let comp: MarchandComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MarchandComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.marchands[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
