...
describe('Ville e2e test', () => {
    ...
    it('should load Villes', async () => {
        ...
        expect(await villeComponentsPage.getTitle()).to.eq('kouponApp.ville.home.title');
    });

    it('should load create Ville page', async () => {
        await villeComponentsPage.clickOnCreateButton();
        villeUpdatePage = new VilleUpdatePage();
        expect(await villeUpdatePage.getPageTitle()).to.eq('kouponApp.ville.home.createOrEditLabel');
    ...
    it('should delete last Ville', async () => {
        ...
        expect(await villeDeleteDialog.getDialogTitle()).to.eq('kouponApp.ville.delete.question');
