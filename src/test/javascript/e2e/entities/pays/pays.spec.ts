...
describe('Pays e2e test', () => {
    ...
    it('should load Pays', async () => {
        ...
        expect(await paysComponentsPage.getTitle()).to.eq('kouponApp.pays.home.title');
    });

    it('should load create Pays page', async () => {
        await paysComponentsPage.clickOnCreateButton();
        paysUpdatePage = new PaysUpdatePage();
        expect(await paysUpdatePage.getPageTitle()).to.eq('kouponApp.pays.home.createOrEditLabel');
    ...
    it('should delete last Pays', async () => {
        ...
        expect(await paysDeleteDialog.getDialogTitle()).to.eq('kouponApp.pays.delete.question');
