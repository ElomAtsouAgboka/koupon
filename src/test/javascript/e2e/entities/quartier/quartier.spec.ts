...
describe('Quartier e2e test', () => {
    ...
    it('should load Quartiers', async () => {
        ...
        expect(await quartierComponentsPage.getTitle()).to.eq('kouponApp.quartier.home.title');
    });
    ...
    it('should load create Quartier page', async () => {
        ...
        expect(await quartierUpdatePage.getPageTitle()).to.eq('kouponApp.quartier.home.createOrEditLabel');
    ...
    it('should delete last Quartier', async () => {
        ...
        expect(await quartierDeleteDialog.getDialogTitle()).to.eq('kouponApp.quartier.delete.question');
