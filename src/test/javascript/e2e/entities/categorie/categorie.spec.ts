...
describe('Categorie e2e test', () => {
    ...
    it('should load Categories', async () => {
        ...
        expect(await categorieComponentsPage.getTitle()).to.eq('kouponApp.categorie.home.title');
    });
    ...
    it('should load create Categorie page', async () => {
        ...
        expect(await categorieUpdatePage.getPageTitle()).to.eq('kouponApp.categorie.home.createOrEditLabel');
    ...
    it('should create and save Categories', async () => {
        ...
        await promise.all([
            ...
            categorieUpdatePage.categorieParentSelectLastOption()
        ]);
    ...
    it('should delete last Categorie', async () => {
        ...
        expect(await categorieDeleteDialog.getDialogTitle()).to.eq('kouponApp.categorie.delete.question');
