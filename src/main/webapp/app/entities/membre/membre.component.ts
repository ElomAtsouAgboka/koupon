...
export class MembreComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.membreService
                ...
                .subscribe(
                    (res: HttpResponse<IMembre[]>) => this.paginateMembres(res.body, res.headers),
    ...
    registerChangeInMembres() {
        this.eventSubscriber = this.eventManager.subscribe('membreListModification', response => this.loadAll());
    }
